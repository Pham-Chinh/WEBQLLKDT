...
<html lang="en">
  <head>
    ...
    .cart-badge {
      ...
      /* Thêm vào thẻ <style> của trang */

/* Div chung để căn chỉnh tất cả các mục của user thẳng hàng */
    .user-area {
            display: flex;
            align-items: center;
            gap: 10px;
        ...
        .user-greeting span {
            ...
            /* hover menu profile*/
.profile-hover-menu {
        position: relative; /* Bắt buộc phải có để menu con định vị theo */
        display: inline-block;
    }

    /* Phần menu ẩn, chỉ hiện ra khi hover */
    .profile-hover-menu .menu-content {
        /* Ẩn đi lúc bình thường */
        visibility: hidden;
        opacity: 0;
        
        position: absolute;
        right: 0; /* Căn lề phải với icon */
        top: 100%; /* Hiện ngay bên dưới icon */
    ...
    /* ✅ DÒNG CODE THẦN KỲ: Khi hover vào thẻ cha... */
    .profile-hover-menu:hover .menu-content {
        /* ...thì menu con sẽ hiện ra */
        visibility: visible;
        opacity: 1;
    }

    /* Tạo kiểu cho các link trong menu */
    .profile-hover-menu .menu-content a {
    ...
    .profile-hover-menu .menu-content a:hover {
        background-color: var(--light-gray-bg);
    }
    
    .profile-hover-menu .menu-content a i {
        width: 20px;
        text-align: center;
...
/*    zalo*/
    /* CSS để làm nút Zalo nổi ở góc màn hình */
    .zalo-chat-widget {
        position: fixed; /* Giúp nút luôn ở một vị trí cố định */
        bottom: 25px;
        right: 25px;
        z-index: 1000;
    }
    ...
    .zalo-chat-widget img {
        width: 60px; /* Kích thước của icon Zalo */
        height: 60px;
        border-radius: 50%; /* Bo tròn */
        box-shadow: 0px 4px 12px rgba(0,0,0,0.3); /* Thêm bóng đổ cho đẹp */
    }
...
<div class="col-sm-8 col-lg-2 d-flex justify-content-center justify-content-sm-end">

    <%-- ✅ SỬA 1: Thêm class "align-items-center" vào đây để căn tất cả các icon thẳng hàng theo chiều dọc --%>
    <ul class="d-flex justify-content-end align-items-center list-unstyled m-0">

        <%-- ✅ SỬA 2: Bọc toàn bộ khu vực user vào trong một thẻ <li> cho đúng chuẩn HTML và không bị lệch --%>
        <li>
            <div class="user-area">
                <%-- Code if/else kiểm tra đăng nhập của bạn được đặt ở đây --%>
               <%-- ✅ BẮT ĐẦU KHỐI CODE DROPDOWN HOÀN CHỈNH --%>
<%-- Bắt đầu phần logic và HTML --%>
<%
    taikhoan loggedInAccount = (taikhoan) session.getAttribute("account");
%>

<% if (loggedInAccount != null) { %>
    <%-- NẾU ĐÃ ĐĂNG NHẬP: HIỂN THỊ MENU HOVER --%>
    <%
        String username = loggedInAccount.getUsername();
        String initial = username.substring(0, 1).toUpperCase();
    %>
    
    <div class="profile-hover-menu">
        <%-- PHẦN LUÔN HIỂN THỊ: Icon và huy hiệu --%>
        <a href="#" class="profile-icon-container">
            <svg width="28" height="28"><use xlink:href="#user"></use></svg>
            <span class="notification-badge"><%= initial %></span>
        </a>
        
        <%-- PHẦN BỊ ẨN: Nội dung menu --%>
...
<% } else { %>
    <%-- NẾU LÀ KHÁCH: HIỂN THỊ LINK ĐĂNG NHẬP NHƯ CŨ --%>
    <div class="user-area">
...
<!-- start banner -->   
    <section style="background-image: url('images/banner-goc.png');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary">Linh kiện điện tử </span><span class="fw-bold"> đến ngay tay bạn</span></h2>
            <p class="fs-4">Đầy đủ - Chính hãng - Giá tốt.</p>
            <div class="d-flex gap-3">
              <a href="#" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Bắt đầu mua sắm..</a>
              <a href="#" class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Tham gia ngay.</a>
            </div>
            <div class="row my-5">
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">1k+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Sản phẩm các loại</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">500+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Khách hàng hài lòng</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">3+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">Cửa hàng toàn quốc</p></div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light">Sản phẩm chính hãng</h5>
                    <p class="card-text">Linh kiện 100% chính hãng,có nguồn gốc rõ ràng,bảo đảm chất lượng.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-secondary rounded-0 p-4 text-light">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light"> Chất lượng cao cấp</h5>
                    <p class="card-text">Tất cả linh kiện được kiểm tra kỹ lưỡng,đáp ứng tiêu chuẩn kỹ thuật..</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col">
            <div class="card border-0 bg-danger rounded-0 p-4 text-light">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="card-body p-0">
                    <h5 class="text-light"> Giao hàng toàn quốc</h5>
                    <p class="card-text">Miễn phí giao hàng với đơn hàng từ 500K,giao nhanh trong 24h.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="category.html" class="nav-link swiper-slide text-center">
                  ...
                  <h4 class="fs-6 mt-3 fw-normal category-title">Linh kiện</h4>
                </a>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
              ...
              <div class="banner-ad d-flex align-items-center large bg-info block-1" style="background: url('images/banner-ai.jpg') no-repeat; background-size: cover;">
                <div class="banner-content p-5">
                  <div class="content-wrapper text-light">
                    <h3 class="banner-title text-light">Sản phẩm giảm giá</h3>
                    <p>Giảm lên tới 30%</p>
                    <a href="#" class="btn-link text-white">Mua sắm ngay</a>
                  </div>
                </div>
              </div>
              
              <div class="banner-ad bg-success-subtle block-2" style="background:url('images/ai2rs.jpg') no-repeat;background-size: cover">
                <div class="banner-content align-items-center p-5">
                  <div class="content-wrapper text-light">
                    <h3 class="banner-title text-light">Combo ưu đãi</h3>
                    <p>Giảm lên tới 50%</p>
                    <a href="#" class="btn-link text-white">Mua sắm ngay</a>
                  </div>
                </div>
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('images/gmnrs.png') no-repeat;background-size: cover">
                <div class="banner-content align-items-center p-5">
                  <div class="content-wrapper text-light">
                    <h3 class="banner-title text-light">Phiếu giảm giá</h3>
                    <p>Giảm lên tới 40%</p>
                    <a href="#" class="btn-link text-white">Mua sắm ngay</a>
                  </div>
                </div>
            ...
            <div class="row justify-content-center">
              <div class="col-md-5 p-3">
                <div class="section-header">
                  <h2 class="section-title display-5 text-light">Giảm giá 25% cho lần mua đầu tiên</h2>
                </div>
                <p>Chỉ cần Đăng nhập & Đăng ký để trở thành hội viên.</p>
              </div>
              <div class="col-md-5 p-3">
                <form>
                  <div class="mb-3">
                    ...
                    <input type="text"
                      class="form-control form-control-md rounded-0" name="name" id="name" placeholder="Tên">
                  </div>
                  <div class="mb-3">
                    <label for="email" class="form-label d-none">Email</label>
                    <input type="email" class="form-control form-control-md rounded-0" name="email" id="email" placeholder="Địa chỉ email">
                  </div>
...
<!--end moi ve-->
        ...
        <div class="row">
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="images/tt1.png" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>2/9/2024</div>
                  <div class="meta-categories"><svg width="16" height="16"><use xlink:href="#category"></use></svg>hướng dẫn</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">Top 10 linh kiện cần thiết cho người mới bắt đầu Arduino</a>
                  </h3>
                  <p>Tìm hiểu những linh kiện cơ bản không thể thiếu khi bắt đầu học lập trình vi điều khiển.</p>
                </div>
              </div>
            </article>
          </div>
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="images/tt2.png" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>25/8/2024</div>
                  <div class="meta-categories"><svg width="16" height="16"><use xlink:href="#category"></use></svg>xu hướng</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">Cách chọn cảm biến phù hợp cho từng loại dự án</a>
                  </h3>
                  <p>Hướng dẫn chọn cảm biến nhiệt độ, độ ẩm, khoảng cách, chuyển động,... theo mục đích sử dụng.</p>
                </div>
              </div>
            </article>
          </div>
          <div class="col-md-4">
            <article class="post-item card border-0 shadow-sm p-3">
              <div class="image-holder zoom-effect">
                <a href="#">
                  <img src="images/tt3.png" alt="post" class="card-img-top">
                </a>
              </div>
              <div class="card-body">
                <div class="post-meta d-flex text-uppercase gap-3 my-2 align-items-center">
                  <div class="meta-date"><svg width="16" height="16"><use xlink:href="#calendar"></use></svg>28/11/2024</div>
                  <div class="meta-categories"><svg width="16" height="16"><use xlink:href="#category"></use></svg>KINH NGHIỆM</div>
                </div>
                <div class="post-header">
                  <h3 class="post-title">
                    <a href="#" class="text-decoration-none">Tự làm xe robot tránh vật với Arduino chỉ trong 1 buổi chiều</a>
                  </h3>
                  <p>Dự án thực tế đơn giản dành cho sinh viên và người mới bắt đầu....</p>
                </div>
              </div>
            </article>
          </div>
    ...
    <section class="py-4">
      <div class="container-lg">
        <h2 class="my-4">Mọi người cũng tìm kiếm</h2>
        <a href="#" class="btn btn-warning me-2 mb-2">Điện trở 10kΩ</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Tụ hóa 100uF</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Transistor C1815</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Cảm biến siêu âm HC-SR04</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Module relay 5V</a>
        <a href="#" class="btn btn-warning me-2 mb-2">IC 555 Timer</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Arduino Uno R3</a>
        <a href="#" class="btn btn-warning me-2 mb-2">Mạch nạp USBasp</a>
          ...
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">Miễn phí cho đơn từ 500k.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">Hỗ trợ chuyển khoản,COD.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">100% sản phẩm đúng mô tả.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                <h5> Giá cực ưu đãi mỗi tuần</h5>
                <p class="card-text">Giá ưu đãi khi khách mua sỉ.</p>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="card mb-3 border border-dark-subtle p-3">
              ...
              <div class="card-body p-0">
                <h5>Ưu đãi mỗi tuần trong tháng</h5>
                <p class="card-text">Giảm giá nhiều linh kiện tốt.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <img src="images/logoc.png" width="240" height="70" alt="logo">
          ...
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">PC Shop</h5>
              <ul class="menu-list list-unstyled">
                <li class="menu-item">
                  <a href="#" class="nav-link">Giới thiệu</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Điều khoản sử dụng </a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Hợp tác đại lý</a>
                </li>
                <li class="menu-item">
                  <a href="#" class="nav-link">Các chi nhánh</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="col-md-2 col-sm-6">
            <div class="footer-menu">
              ...
              <ul class="menu-list list-unstyled">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Phiếu giảm giá</a>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item">
                  <a href="#" class="nav-link">Hỗ trợ kĩ thuật</a>
                </li>
                <li class="menu-item">
          ...
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer-menu">
              <h5 class="widget-title">Đăng ký nhận tin tức về sản phẩm</h5>
              <p>Nhận ưu đãi, tin tức & tài liệu kỹ thuật mới nhất.</p>
              <form class="d-flex mt-3 gap-0" action="index.jsp">
                <input class="form-control rounded-start rounded-0 bg-light" type="email" placeholder="Địa chỉ email" aria-label="Email Address">
      ...
      <div class="container-lg">
        <div class="row">
          <div class="col-md-6 copyright">
            <p>© 2025 Ph.Chinh. All rights reserved.</p>
          </div>
          <div class="col-md-6 credit-link text-start text-md-end">
              <p>Bản quyền thuộc về Pham Chinh</p>
          </div>
        </div>
      </div>
    </div>
...
<%-- =============================================== --%>
<%-- ✅ BẮT ĐẦU: CODE NÚT CHAT ZALO --%>



<div class="zalo-chat-widget">
    <%-- Thay đổi số điện thoại của bạn ở đây --%>
    <a href="https://zalo.me/84394572135" target="_blank">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Icon_of_Zalo.svg/2048px-Icon_of_Zalo.svg.png" alt="Chat với chúng tôi qua Zalo">
    </a>
</div>
<%-- KẾT THÚC: CODE NÚT CHAT ZALO --%>
<%-- =============================================== --%>
</body>
</html>