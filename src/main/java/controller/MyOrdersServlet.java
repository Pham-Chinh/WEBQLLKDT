...
public class MyOrdersServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Bước 2: Lấy ID của người dùng đã đăng nhập
        int userId = account.getId();
        
        // Bước 3: Gọi DAO để lấy danh sách đơn hàng của user này
        List<Order> myOrderList = OrderDAO.getOrdersByUserId(userId);
        
        // Bước 4: Đặt danh sách vào request để gửi cho trang JSP
        request.setAttribute("myOrderList", myOrderList);
        
        // Bước 5: Chuyển đến trang JSP để hiển thị
